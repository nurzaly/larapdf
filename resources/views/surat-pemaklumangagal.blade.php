...
<head>
<meta charset="utf-8">
<title>Surat Pemakluman (Gagal)</title>
    ...
    <tr>
      <td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
        <tbody>
          ...
          <tr>
            <td style="text-align: center">(Letterhead Institut)</td>
          </tr>
          <tr>
            <td>&nbsp;</td>
          </tr>
          ...
          <tr>
            <td style="text-align: right">Tarikh: 1 Jun 2020</td>
          </tr>
          <tr>
            <td style="text-align: right">No. Rujukan: ILPSDK/xx/yy-z/z (?)</td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="font-weight: bold">Tuan,</td>
          </tr>
          <tr>
